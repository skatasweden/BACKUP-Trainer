-- Fix get_workout_with_details to prioritize program_item with video data
...
begin
  ...
  left join lateral (
    -- Get program_item from the specific program context - PRIORITIZE ITEMS WITH VIDEO DATA
    ...
    from (
      ...
      order by 
        ...
        -- CRITICAL: Prioritize items with video data
